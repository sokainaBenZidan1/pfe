...
@Component({
  selector: 'app-operation-stock-create-admin',
  templateUrl: './operation-stock-create-admin.component.html'
})
export class OperationStockCreateAdminComponent extends AbstractCreateController<OperationStockDto, OperationStockCriteria, OperationStockAdminService>  implements OnInit {
   ...
   private _validOperationStockMagasinDest = true;
    ...
    public validateOperationStockDetailsQte(){
    ...
    public validateOperationStockDetailsProduit(){
    ...
    public validateOperationStockDetailsOperationStock(){
