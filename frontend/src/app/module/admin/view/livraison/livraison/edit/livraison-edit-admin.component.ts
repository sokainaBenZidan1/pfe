...
export class LivraisonEditAdminComponent extends AbstractEditController<LivraisonDto, LivraisonCriteria, LivraisonAdminService>   implements OnInit {
    ...
    public validateLivraisonDetails(){
   ...
   public addLivraisonDetails() {
       ...
       if (this.errorMessages.length === 0) {
            if(this.livraisonDetailsElement.id == null){
                this.item.livraisonDetails.push(this.livraisonDetailsElement);
            }else{
                const index = this.item.livraisonDetails.findIndex(e => e.id == this.livraisonDetailsElement.id);
                this.item.livraisonDetails[index] = this.livraisonDetailsElement;
            }
    ...
    private validateLivraisonDetailsQte(){
    ...
    private validateLivraisonDetailsMagasin(){
    ...
    private validateLivraisonDetailsProduit(){
    ...
    private validateLivraisonDetailsLivraison(){
