...
@Component({
  selector: 'app-livraison-detail-create-admin',
  templateUrl: './livraison-detail-create-admin.component.html'
})
export class LivraisonDetailCreateAdminComponent extends AbstractCreateController<LivraisonDetailDto, LivraisonDetailCriteria, LivraisonDetailAdminService>  implements OnInit {
