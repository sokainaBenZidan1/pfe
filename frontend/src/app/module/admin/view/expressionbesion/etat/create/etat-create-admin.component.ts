...
@Component({
  selector: 'app-etat-create-admin',
  templateUrl: './etat-create-admin.component.html'
})
export class EtatCreateAdminComponent extends AbstractCreateController<EtatDto, EtatCriteria, EtatAdminService>  implements OnInit {
