...
export class ReceptionCreateAdminComponent extends AbstractCreateController<ReceptionDto, ReceptionCriteria, ReceptionAdminService>  implements OnInit {
   ...
   private _validReceptionCommande = true;
    ...
    public validateReceptionDetailsQte(){
    ...
    public validateReceptionDetailsMagasin(){
    ...
    public validateReceptionDetailsProduit(){
    ...
    public validateReceptionDetailsReception(){
