...
export class MandatEditAdminComponent extends AbstractEditController<MandatDto, MandatCriteria, MandatAdminService>   implements OnInit {
    ...
    public override prepareEdit() {
        this.item.dateDebut = this.mandatService.format(this.item.dateDebut);
        this.item.dateFin = this.mandatService.format(this.item.dateFin);
    }
