...
@Component({
  selector: 'app-responsable-inventaire-edit-admin',
  templateUrl: './responsable-inventaire-edit-admin.component.html'
})
export class ResponsableInventaireEditAdminComponent extends AbstractEditController<ResponsableInventaireDto, ResponsableInventaireCriteria, ResponsableInventaireAdminService>   implements OnInit {
