...
@Component({
  selector: 'app-inventaire-detail-create-admin',
  templateUrl: './inventaire-detail-create-admin.component.html'
})
export class InventaireDetailCreateAdminComponent extends AbstractCreateController<InventaireDetailDto, InventaireDetailCriteria, InventaireDetailAdminService>  implements OnInit {
